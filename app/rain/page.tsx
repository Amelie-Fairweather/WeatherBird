    ...
    <div className="min-h-screen bg-[var(--offWhite)]">
      ...
      <div className="p-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold font-cormorant text-[var(--darkBlue)] mb-6">Rain Information</h1>
          <p className="text-lg font-cormorant">Rain-related weather information and flood safety tips.</p>
        </div>
      </div>
    </div>
  );
